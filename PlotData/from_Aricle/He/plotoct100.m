...
filename="CROSS_100mev.dat";
column_number = 3;

data02=dlmread("data/2.dat1.0.2.100p8mev","",2,0);
data12=dlmread("data/2.dat1.1.2.100p8mev","",2,0);
data22=dlmread("data/2.dat1.2.2.100p8mev","",2,0);
data32=dlmread("data/2.dat1.3.2.100p8mev","",2,0);
data41=dlmread("data/2.dat1.4.1.100p8mev","",2,0);
data42=dlmread("data/2.dat1.4.2.100p8mev","",2,0);
data43=dlmread("data/2.dat1.4.3.100p8mev","",2,0);
data44=dlmread("data/2.dat1.4.4.100p8mev","",2,0);
data52=dlmread("data/2.dat1.5.2.100p8mev","",2,0);
