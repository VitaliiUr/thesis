...
set key at 120, graph 0.93 font ",10"
...
set key at 135, graph 0.93 font ",10" 
set label 1 "(c)"
set xtics 0,30,180

set style fill transparent solid 0.25 # partial transparency
# set style fill noborder # no separate top/bottom lines
plot "./data/Trunc_VU100MeV_AX_sms.dat" u 1:6  notitle "SMS N^4LO+" lw 0.0001 lc "blue"  w filledcurves,\
	"./data/DeutAX_Deg_100mev.dat" u 1:(-$10)  w l title "SMS N^4LO+" ls 6 lw 1 lc "blue",\
	"./dataSCS/Trunc_VU100MeV_AX_scs.dat" u 1:5 notitle "SCS N^4LO" lw 0.0001  lc rgb "#ff0000"   w filledcurves,\
      "./dataSCS/DeutAX_Deg_100mev_scs.dat" u 1:(-$6) w l dt 2 lw 1 lc rgb "#DB0000" title "SCS N4LO"
