...
filename="DeutAX_Deg_30mev.dat";
column_number = 5;

data02=dlmread("2.dat3.0.2.19p8mev","",1,0);
data12=dlmread("2.dat3.1.2.19p8mev","",1,0);
data22=dlmread("2.dat3.2.2.19p8mev","",1,0);
data32=dlmread("2.dat3.3.2.19p8mev","",1,0);
data41=dlmread("2.dat3.4.1.19p8mev","",1,0);
data42=dlmread("2.dat3.4.2.19p8mev","",1,0);
data43=dlmread("2.dat3.4.3.19p8mev","",1,0);
data44=dlmread("2.dat3.4.4.19p8mev","",1,0);
data52=dlmread("2.dat3.5.2.19p8mev","",1,0);
dataAV18=dlmread("2.dat3.av18.30mev","",1,0);
