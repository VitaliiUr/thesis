...
filename="ProtonPolDeg_100mev.dat";


data02=dlmread("2.dat4.0.2.100p8mev","",1,0);
data12=dlmread("2.dat4.1.2.100p8mev","",1,0);
data22=dlmread("2.dat4.2.2.100p8mev","",1,0);
data32=dlmread("2.dat4.3.2.100p8mev","",1,0);
data41=dlmread("2.dat4.4.1.100p8mev","",1,0);
data42=dlmread("2.dat4.4.2.100p8mev","",1,0);
data43=dlmread("2.dat4.4.3.100p8mev","",1,0);
data44=dlmread("2.dat4.4.4.100p8mev","",1,0);
data52=dlmread("2.dat4.5.2.100p8mev","",1,0);
dataAV18=dlmread("2.dat4.av18.100mev","",1,0);
Pi=3.14159265359;
