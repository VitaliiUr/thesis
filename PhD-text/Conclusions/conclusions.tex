...
\begin{enumerate}
    ...
    \item \tmp{For $\pi + ^3$H there are 3 neuterons in the final state. It is a very unusual but interesting situation}
    \item \tmp{For pion absorption write if I suggest measurements in FSI configuration, QFS configuration or other.}
\end{enumerate}
