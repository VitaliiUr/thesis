...
\begin{enumerate}
    ...
    \item Looking at the FSI contribution I see that it is bigger at larger energies.
    For example in \fig{Diff_cross_pw_1nc} we see that difference between "PW" and "Full" curves
