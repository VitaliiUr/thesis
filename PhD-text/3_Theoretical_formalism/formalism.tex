...
\label{nd_state}
    ...
    In \eq{j_mu_gen} $j_\mu^n$ is a contribution from the interaction between a photon and 
    ...
    In \eq{3n_conv} and \eq{3n_spin} we present conventional and spin currents which combined form a spatial component of the 
