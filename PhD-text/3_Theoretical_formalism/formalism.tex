...
\label{nd_state}
    ...
    $n$ nucleons (and $j_\mu^3$ is presented in 3N system only).

    In 2N system we have an explicit definition for a single nucleon current (1NC) only,
    which is consistent with our frameworks. 
    ...
    \begin{equation}
        \begin{aligned}
        \matrixel{\pvec{p}} {j_1^\mu(0)} {\vec{p}} & =& \bar{u}\left(\pvec{p} s^{\prime}\right)\left(\gamma^\mu F_1+i \sigma^{\mu \nu}\left(p^{\prime}-p\right)_\nu F_2\right) u(\vec{p} s) \\
    ...
    \begin{equation}
        \begin{array}{r}
            \left\langle\pvec{p}\left| j_1^0(0)\right| \vec{p}\right\rangle=\left(G_E^p \Pi^p+G_E^n \Pi^n\right), \\
            \left\langle\pvec{p}\left| \vec{J}_1(0)\right| \vec{p}\right\rangle=\frac{\vec{p}+\pvec{p}}{2 M_N}\left(G_E^p \Pi^p+G_E^n \Pi^n\right)+\frac{i}{2 M_N}\left(G_M^p \Pi^p+G_M^n \Pi^n\right) \vec{\sigma} \times\left(\pvec{p}-\vec{p}\right) .
        \end{array}
    \end{equation}
