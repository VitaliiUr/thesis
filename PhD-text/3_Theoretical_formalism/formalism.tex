...
\section{The Lippman-Schwinger equation}
    ...
    because this term is always vanished and NLO  corresponds to the second term}. Here $p$ specifies
    ...
    \end{equation}
    then chiral expansion for X is:
    ...
    \begin{figure}[h]
        \begin{center}
        \includegraphics[width=0.95\textwidth]{Figures_python/TOTAL_CROSSSECTION_Truncation_100mev.pdf}
        \end{center}
        \caption{Total cross section as a dependance on the chiral order for the E$_\gamma$=100~MeV.
