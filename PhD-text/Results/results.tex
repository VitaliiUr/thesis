...
\label{sec:de_results}
    ...
    curves are getting closer to each other and the difference
    ...
    using NN potential beyond \gls{n4lo+} chiral orders would rather not bring a significant contribution 
    ...
    A similar discrepancy with the data observed for both potentials
    ...
    In the case of deuteron's tensor analyzing power components, the contribution of the rescattering part is  
    ...
    given that the experiment was conducted back in 1989.
    ...
    only for lower energies and the difference with the data becomes larger
    ...
    have some deviations from the symmetrical form. This suggests that some problems with the data can be
    ...
    of the points (e.g. around \ang{50}) have a prediction in a distance of more than one standard deviation.
...
\section{Triton 3N photodisintegration}
    ...
    In the \fig{CROSS_Triton_EXCL_30_15_0_15_180} I show a differential cross section 
    $\frac{d^5\sigma}{d\Omega_1d\Omega_2dS}$ as a function of the S-arclength.
    ...
    Both truncation errors and cut-off dependence are smaller with such a configuration:
...
on $^2$H, $^3$H, and $^3$He. For these reactions, the total absorption rate is observable
...
\begin{figure}[h]
    ...
    and were obtained as for $\Gamma_{pnn}$ (\eq{Gam_nd_pnn_our}).
