...
\section{Triton 3N photodisintegration}
    ...
    $\frac{d^5\sigma}{d\Omega_1d\Omega_2dS}$ as a function of the S-arclength.
    As for the example presented in \fig{CROSS_HE_EXCL_30} I use
...
\begin{figure}[h]
    ...
    by the total value $\sum_{i=1}^{4}\Gamma_i$. Results are presented in the Table \ref{tableregions_norm}.
    ...
    \fig{pion_map_E1E2_cutoff}, but from the current perspective it is clearly presented.
    ...
    and \SI{32.0}{\percent} with respect to cutoff parameter $\Lambda$.
    ...
    and \SI{33.5}{\percent} with respect to cutoff parameter $\Lambda$.
