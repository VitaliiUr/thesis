...
\label{sec:de_results}
    ...
    A priori, various polarization \tmp{stats???} and measurements
    ...
    In addition, experimental uncertainties are larger at small angles and in all cases \tmp{unclear ??}.
    ...
    \begin{figure}[h]
        ...
        The pink dashed line is similar prediction but with the SN only. 
    ...
    are obtained with a one-body current using the Bonn \tmp{explain OBEPR}
    ...
    \begin{figure}[h]
        ...
        \end{center}
        \caption{\tmp{make cutof dependance vs energy}
    ...
    \begin{figure}[h]
        ...
        the nuclear current reduced to the SN current only. 
    ...
    \tmp{TODO: PW, 1NC and Siegert for proton polarization.}
