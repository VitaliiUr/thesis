...
\section{Triton photodisintegration}
    ...
    The cutoff spread around maxima values is \SI{6.25}{\percent} (at $S=\SI{4}{\mev}$) and it is
    ...
    The cutoff spread also becomes larger with increasing energy value: \SI{9.52}{\percent}
    at the same (maximum).

    The truncation error bands and cutoff dependance is very similar as it was for
    ...
    Both truncation errors and cutoff dependance are lower at this configuration:
    ...
    at \gls{n4lo+}. The relative cutoff spread is \SI{0.93}{\percent} at the same point.
    ...
    the cutoff spread is \SI{13.04}{\percent} (all at $S=\SI{35}{\mev}$).
...
\subsection{Pion absorption in $^2$H}
    ...
    \begin{figure}[h]
        ...
        \caption{
            ...
            The rates were calculated using the \gls{sms} force with different chiral orders and cutoff values.
