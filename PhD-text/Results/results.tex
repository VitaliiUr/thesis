...
\label{sec:de_results}
    ...
    is nearly 17 times bigger that due to the truncation error ($4.11/0.26 = 16.96$).
     ...
     is larger: we see not only quantitative, butalso a qualitative variations.
     The \gls{snc} curve has much larger values and its shape becomes 
     more asymetric with respect to the $\theta_p = \ang{90}$ point.
    ...
    different model commponents to the obtained predictions.
    ...
    Both these uncomplete predictions are farther from the experimental data,
