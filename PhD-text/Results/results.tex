...
\section{Deuteron photodisintegraion}
    ...
    \begin{figure}[h]
        ...
        The experimental data are from \cite{BOSMAN1979} (black filled circles),
        \cite{Birenbaum1985} (empty circles),
        \cite{Moreh1989} (red squares),
        \cite{Bernabei1986} (olive triangles),
        \cite{ARENDS1984} (cyan crosses X) and
        \cite{Skopik1974} (magenta dimonds).
        }
        \label{TOTAL_CROSS}
    \end{figure}
