...
\label{sec:de_results}
    ...
    at N$^2$LO it is \SI{1.25}{\percent} at $E_\gamma=$~\SI{30}{\mev}
    ...
    Namely, while on
    the top of \fig{Diff_cross_err} ($E_\gamma=$~\SI{30}{\mev}) the cutoff dependance is so tiny,
    ...
    $\Lambda$-dependance is  \SI{3.35}{\percent} at \SI{100}{\mev}
    and \SI{5.66}{\percent} at \SI{140}{\mev} (the same $\theta_p$).
    Thus at two higher energies the cut-off dependance becomes more important
    ...
    the dependance drops to \SI{1.98}{\percent} at $E_\gamma=\SI{140}{\mev}$. 
    ...
    \begin{figure}[h]
        ...
        {\bf (b)} Predictions obtained with the chiral N$^4$LO+ potential and $\Lambda=\SI{450}{\mev}$
        with various models of nuclear current(1N and 2N) and scattering state.
        The blue solid curve is plane-wave plus rescattering parts, 1NC + Siegert(the same as N$^4$LO+ line in (a)).
    ...
    \begin{figure}[h]
        ...
        Results are obtained using the \gls{sms} potential at different chiral orders (from NLO to N$^4$LO+) 
        ...
        and the chiral potential N$^4$LO+. 
