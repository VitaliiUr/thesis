...
\section{Deuteron photodisintegraion}
    ...
    \begin{figure}[htb]
        \centering
        \begin{subfigure}[b]{0.46\textwidth}
            \includegraphics[width=\textwidth]{Figures_python/T20D2_30mev.pdf}
            \caption{T$_{20}$}
            \label{T20_30_vert}
        \end{subfigure}
        \begin{subfigure}[b]{0.46\textwidth}
            \includegraphics[width=\textwidth]{Figures_python/T21D2_30mev.pdf}
            \caption{T$_{21}$}
            \label{T21_30_vert}
        \end{subfigure}
    ...
    \begin{figure}[htb]
        \centering
        \begin{subfigure}[b]{0.46\textwidth}
            \includegraphics[width=\textwidth]{Figures_python/T22D2_30mev.pdf}
            \caption{T$_{22}$}
            \label{T22_30_vert}
        \end{subfigure}
        \begin{subfigure}[b]{0.46\textwidth}
            \includegraphics[width=\textwidth]{Figures_python/T11D2_30mev.pdf}
            \caption{iT$_{11}$}
            \label{T11_30_vert}
        \end{subfigure}
