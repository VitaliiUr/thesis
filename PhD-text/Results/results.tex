...
\label{sec:de_results}
    ...
    are very similar to these from the \gls{n4lo+} \gls{sms} \tmp{tmp: give numbers} force at lower energies
    ...
    In addition, experimental uncertainties are larger at small angles and in all cases \tmp{unclear -> photo on phone ??}.
    ...
    \tmp{TODO: PW, 1NC and Full for proton asymetry as function of energy (or angles). 
    Similar to 3.11}
