...
\section{Deuteron photodisintegraion}
    ...
    At \SI{100}{\mev} descripancy is larger and relative difference reaches 46\% with absolute difference up to 1.39~\unit{\micro \barn \per \steradian}.
    ...
    Predictions obtained with AV18 potential (dashed-dotted purple line on the \fig{Diff_cross_order}) show that
    ...
    It can be connected with our potential's quality loss, but AV18 can
    ...
    On the top of \fig{Diff_cross_cutoff} the cutoff dependance is so weak,
    ...
    Although the spread is visible, it is not so large and even for \SI{140}{\mev}
    it is within 12\%. 
    ...
    \begin{figure}[h]
        ...
        for the photon's energy \SI{30}{\mev} (top), \SI{100}{\mev} (middle) and \SI{140}{\mev} (bottom). Results on {\bf (a)} are obtained using potential
        with different chiral orders (from LO to N$^4$LO+) with cutoff parameter $\Lambda=450$~MeV and 
    ...
    \begin{figure}[h]
        ...
        with cutoff parameter $\Lambda=\SI{450}{\mev}$.
        ...
        and dotted blues line - \SI{550}{\mev}) and chiral potential N$^4$LO+. 
        Data points (filled and empty circles) are from \cite{Ying_Experiment_Deut}
        (for \SIlist[list-units = single]{30; 100}{\mev})
        and \cite{DeSanctis_Experiment_Deut} (for \SI{140}{\mev}).}
