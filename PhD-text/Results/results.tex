...
\label{sec:de_results}
    ...
    \begin{figure}[h]
        ...
        as a function of the outgoing proton angle in the center of mass frame 
        for the photon energy \SI{30}{\mev} (a) and \SI{100}{\mev} (b).
    ...
    \begin{figure}[h]
        ...
        for the photon energy 2.75 MeV(a) and \SI{100}{\mev}(b).
        Top row presents results obtained using potential
        with different chiral orders (from LO to \gls{n4lo+}) with cutoff parameter $\Lambda=\SI{450}{\mev}$.
        The middle pane shows truncation errors for each 
        chiral order starting from NLO and
    ...
    have  \SI{1.23}{\percent}, so the difference is tremendous.
        ...
        \begin{figure}[h]
            \begin{center}
                ...
                \end{center}
                \caption{The same as In the \fig{CROSS_HE_EXCL_75_75_75_105} but with three-nucleon force.}
    ...
    Figs.\ref{CROSS_HE_EXCL_165_15_15_165} and \ref{CROSS_HE_EXCL_165_15_15_165_3NF}.
        ...
        \begin{figure}[h]
            \begin{center}
                ...
                \end{center}
                \caption{The same as In the \fig{CROSS_HE_EXCL_15_105_15_75} but but with three-nucleon force.}
        ...
        \begin{figure}[h]
            \begin{center}
                ...
                \end{center}
                \caption{The same as In the \fig{CROSS_HE_EXCL_45_75_45_105} but but with three-nucleon force.}
        ...
        \begin{figure}[h]
            \begin{center}
                ...
                \end{center}
                \caption{The same as In the \fig{CROSS_HE_EXCL_165_15_15_165} but but with three-nucleon force.}
