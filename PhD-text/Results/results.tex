...
\begin{figure}[h]
    ...
    The only difference between that various panels is seen is in the distribution of the region with the lowest values of 
    ...
    Figs.~\ref{pion_nnn_E1E2_order} and \ref{pion_nnn_xy_order} show similar intensity plots but here each panel includes
    ...
    \begin{figure}[h]
        ...
        process obtained using the SMS NN potential supplemented by \gls{n2lo} 3NF
