...
\section{Triton photodisintegration}
    ...
    The truncation error bands and cut-off dependence is very similar to what it was found for
    ...
    Both truncation errors and cut-off dependence are smaller at this configuration:
...
\begin{figure}[h]
    ...
    noticed with the naked eye is that area of the central region (corresponding to the smallest rates)
    ...
    one-sixth. In \fig{pion_map_E1E2_cutoff} we see this region at the very right region (with $E_1 \rightarrow 85$)
    with rapid growth of the absorption rate and it is observed at every value of the cut-off parameter. The very same region 
    is presented in  \fig{pion_map_xy_cutoff_PW} at $y \rightarrow 1$. \tmp{Explain what happens with the rest of energy?}
    ...
    Presented above intensity plots correspond to exclusive \tmp{processes} with two particles detected.
