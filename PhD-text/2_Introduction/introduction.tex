...
At some moment Bochum-Bonn goup faced with a problem of potential regularisation\cite{skibiki_wita}.
...
as a function on the momentum $|\vec{p}|$ with fixed value $|\pvec{p}|$=\SI{0.054}{fm^{-1}}.\footnote{
    ...
    observables comprise \tmp{unclear from correction}
}
...
\begin{figure}[htb]
    ...
    value of the momentum $p'=\SI{1.798}{fm^{-1}}$. \tmp{correct labels}
    }
