...
\newcommand{\ppvec}[1]{\vec{#1}\mkern2mu\vphantom{#1}'\vphantom{#1}'}
...
\makeglossaries
\newacronym{2n}{2N}{two-nucleon}
\newacronym{snc}{1NC}{single nucleon current}
\newacronym{2nc}{2NC}{two nucleon current}
...
A Testing Ground for Chiral SMS Model
\\[0.4cm] 
}
\HRule \\[0.4cm]

% Studying chiral models in two- and three-nucleon systems via photodisintegration and pion absorption processes
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\input{PhD-text/Conclusions/conclusions.tex}
